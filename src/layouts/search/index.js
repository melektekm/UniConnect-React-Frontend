      ...
      buttons: [
        {
          ...
          onClick: async () => {
            ...
            try {
              await axios.delete(
                `http://localhost/mint_cafe_laravel_backend/public/api/menu-items/${menuId}`,
                {
                  headers: {
                    Authorization:
        ...
        <TableRow key={employee.id}>
          ...
          <IconButton onClick={(e) => handleMenuClick(employee, e)}>
                    ...
                    >
                      ...
                      <MenuItem value='add_to_buy_food'>Add to Buy Food</MenuItem>
                      <MenuItem value='add_to_employee_edit'>Add to Employee Edit</MenuItem>
                    </Select>
