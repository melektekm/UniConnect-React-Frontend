  ...
  const handlePostAnnouncement = async () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        setErrorMessage("Failed to post Notification. Please try again.");
        setDialogOpen(true);
      }
    } catch (error) {
      setErrorMessage("An error occurred while posting the Notification.");
      setDialogOpen(true);
    } finally {
      setLoading(false);
    }
              ...
              <MDBox pt={3} pb={3} px={2}>
                ...
                <MDBox mt={2} mb={1} textAlign="center">
                  <MDButton
                    ...
                    disabled={loading}
                  >
                    {loading ? "Uploading..." : "Upload Notification"}
                  </MDButton>
                </MDBox>
              </MDBox>
            </Card>
